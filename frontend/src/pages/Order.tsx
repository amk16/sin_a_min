...
const CoffeeLandingPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-50 flex flex-row-reverse relative">
      {/* Vertical line aligning with Landing page */}
      <div className="absolute left-11 top-0 w-px bg-gray-300 h-60 z-20"></div>
      ...
      {/* Right Side - Content */}
      <div className="w-1/2 flex items-center justify-center px-16 bg-[#eae5de]">
        <div className="max-w-md">
          ...
          {/* Main Content */}
          <h1 className="text-7xl font-light mb-8 tracking-tight">Latte</h1>
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 flex flex-col space-y-3 z-10">
        ...
        <div className="w-6 h-6 rounded-full bg-yellow-700 border-2 border-white"></div>
        <div className="w-6 h-6 rounded-full bg-yellow-900 border-2 border-white"></div>
        <div className="w-6 h-6 rounded-full bg-amber-950 border-2 border-white"></div>
      </div>
